...
import com.sneakerShop.entity.ChiTietSanPham;
...
public class SanPhamDAO implements SanPhamImp {
	...
	public List<SanPham> LayDanhSachSanPhamLimit(int spbatdau) {
		...
		if (spbatdau < 0) {
			...
			listSanPhams = (List<SanPham>) session.createQuery("from SANPHAM").setFirstResult(spbatdau).setMaxResults(12)
					.getResultList();
		}
	...
	public SanPham LayDanhSachChiTietSanPhamTheoMa(int masanpham) {
		...
		System.out.println(sanPhams.getChitietsanpham());
		return sanPhams;
	}
