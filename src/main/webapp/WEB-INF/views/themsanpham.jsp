...
<!-- jQuery -->
<script src='<c:url value="/resources/JavaScripts/jquery-3.2.1.min.js"/>'></script>
<!-- //jQuery -->
...
<!--js -->
<script src='<c:url value="/resources/JavaScripts/jquery.nicescroll.js"/>'></script>
<script src='<c:url value="/resources/JavaScripts/scripts.js"/>'></script>
<script src='<c:url value="/resources/JavaScripts/custom.js"/>'></script>
...
<script src='<c:url value="/resources/JavaScripts/morris.js"/>'></script>
