		...
		<nav class="navbar navbar-default none_nav wow rubberBand">
		  <div class="container-fluid">
		    ...
		    <div class="navbar-header">
		      ...
		      <a class="navbar-brand" href="http://localhost:8080/sneakerShop/"><img src='<c:url value="/resources/Image/balen.jpg"/>'style="width: 100px"></a>
		    </div>
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav navbar-center">
		        ...
		        <li><a href="https://bitly.com.vn/uubbux" target="_blank" >DỊCH VỤ</a></li>
		        <li><a href="https://www.facebook.com/DoThat98/" target="_blank">LIÊN HỆ</a></li>
...
<%-- 	<div class="container">
	...
	<div id="title-sanpham" class="container">
		<span style="font-size: 23px; font-weight: 350;">SẢN PHẨM HOT</span>
	...
	<div id="footer" class="container-fluid">
		<div class="row">
			<div class="col-sm-4 col-md-4 wow tada">
				...
				<span>Real Sneaker là một thương hiệu thời trang đầy uy tín, luôn đảm bảo chất lượng sản phẩm tốt nhất cho khách hàng.</span>
			</div>
			
			<div class="col-sm-4 col-md-4 wow tada">
				<p><span class="title-footer">LIÊN HỆ</span></p>
				<span>116 Phố Viên - Đức Thắng - Bắc Từ Liêm  TP. Hà Nội</span>
				<span>dothat998@gmail.com</span>
